...
ROUTES_DATA = [
    ...
    },
    {
        ...
        "duration": "7 分（3 站直達）",
        "ticket_title": "票券與相關資訊",
        "ticket_sub": "ATB Bergamo 市區公車 1 號（或 24H 觀光通票）",
        "ticket_price": "單程 €1.70 / 24H 通票 €4.00",
        "operator": "ATB Bergamo",
        "operator_note": "火車站前搭乘 ATB 1 號公車直達「V.le Vittorio Emanuele 47」站下車，下車正對登山纜車下站（Funicolare Bassa），過馬路即可轉乘纜車登頂上城",
        "transit_type": "bus",
