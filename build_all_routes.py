...
ROUTES_DATA = [
    ...
    },
    {
        ...
        "ticket_price": "米蘭通票 / 單程 €2.20",
        "operator": "米蘭大眾運輸 ATM",
        "operator_note": "於威尼斯門街區晚餐（FRESCA Pasta Club）後，步行至 Viale Vittorio Veneto 搭乘路面輕軌 9 號直達 Via Filzi - Via Galvani 站（加爾瓦尼站，下車前一站：Filzi / Pirelli）。下車即為 Via Luigi Galvani 街口，轉彎即抵達飯店（Via Luigi Galvani 12）休息",
        "transit_type": "tram",
    ...
    },
    {
        "id": "route_06",
        "day": "DAY 04",
        "day_badge": "D04 · 公車 1 號 ➔ 登山纜車",
        "title": "貝爾加莫車站 至 貝爾加莫上城老廣場（公車 1 號至 Vittorio Emanuele 47 ➔ 登山纜車）",
        "origin_name": "貝爾加莫火車站前（Bergamo Stazione FS）",
        "origin_addr": "Piazza Guglielmo Marconi 1, 24122 Bergamo BG, 義大利",
        "dest_name": "老廣場（Piazza Vecchia · 聖母聖殿）",
        "dest_addr": "Piazza Vecchia, 24129 Bergamo BG, 義大利",
        "dep_time": "10:05",
        "arr_time": "10:22",
        "duration": "17 分（公車 1 號 ➔ 百年登山纜車）",
        "ticket_title": "票券與相關資訊",
        "ticket_sub": "ATB Bergamo 24H 觀光通票（公車與登山纜車通用）",
        "ticket_price": "€4.00（24H 通票）",
        "operator": "ATB Bergamo",
        "operator_note": "站前搭 1 號公車至「Vittorio Emanuele 47」站下車，正對登山纜車下站，轉乘百年傾斜纜車直登 Città Alta 鞋市廣場，漫步 3 分鐘抵達老廣場",
        "transit_type": "funicular",
        "transit_badge": "🚌 公車 1 號 ➔ 🚡 Funicolare 登山纜車",
        "line_color": "#ff6f00",
        ...
        "alert": "轉乘提示：公車 1 號搭乘至「V.le Vittorio Emanuele 47」站下車，過馬路即為登山纜車站（Funicolare Bassa）。使用同一張 24H 通票搭乘纜車登頂至鞋市廣場（P.za Mercato delle Scarpe），漫步 3 分鐘穿過古街即達老廣場（Piazza Vecchia）。",
        "stops": [
            ...
            {"time": "10:09", "name": "Porta Nuova（新門）", "coord": [45.6953, 9.6700]},
            {"time": "10:12", "name": "V.le Vittorio Emanuele 47（公車下車站 · 正對登山纜車下站）", "coord": [45.7008, 9.6669]},
            {"time": "10:15", "name": "Funicolare Bassa（轉搭百年登山纜車）", "coord": [45.7010, 9.6665]},
            {"time": "10:18", "name": "Funicolare Alta（抵達上城鞋市廣場 P.za Mercato delle Scarpe）", "coord": [45.7032, 9.6644]},
            {"time": "10:22", "name": "Piazza Vecchia（抵達老廣場 · 穿過高姆比托塔古街即達）", "coord": [45.7042, 9.6628], "is_end": True}
        ]
    },
    {
        "id": "route_07",
        ...
        "operator": "ATB Bergamo",
        "operator_note": "漫步城牆與聖賈科莫門後，於門前站牌搭乘 1 號公車下山直達「Paleocapa 1」站，下車過街 1 分鐘即達火車站大廳，搭乘 15:02 RE 2232 區域快車準時返回米蘭中央車站",
        "transit_type": "bus",
...
ROUTE_PDF_MAPPING = {
    ...
    "route_06": "06_D04_貝爾加莫車站_至_Vittorio_Emanuele47纜車老廣場.pdf",
