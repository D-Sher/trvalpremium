...
ROUTES_DATA = [
    ...
    },
    {
        ...
        "ticket_sub": "PASS SUD AZUR 南法通票感應卡（輕軌與公車無限搭乘）",
        "ticket_price": "持 PASS SUD AZUR 通票搭乘（感應進站）",
        "operator": "尼斯都會大眾運輸 Lignes d'Azur",
        "operator_note": "走出 AC Hotel 穿過馬路即達 C.U.M. 輕軌地下站，持 PASS SUD AZUR 感應卡進站直達舊城免日曬爬坡",
        "transit_type": "tram",
